                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="manufacture_date" id="manufacture_date" value="<?php echo $pdf_form_datas[0]['manufacture_date']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="registration_number_owner_no" id="registration_number_owner_no" value="<?php echo $pdf_form_datas[0]['registration_number_owner_no']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="model_serial_number" id="model_serial_number" value="<?php echo $pdf_form_datas[0]['model_serial_number']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="manufacturer_documentation" id="manufacturer_documentation" value="<?php echo $pdf_form_datas[0]['manufacturer_documentation']; ?>">
                                        </div>
                                    </div>
                                  </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="prev_inspection_date_cert_no" id="prev_inspection_date_cert_no" value="<?php echo $pdf_form_datas[0]['prev_inspection_date_cert_no']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="next_inspection_date" id="next_inspection_date" value="<?php echo $pdf_form_datas[0]['next_inspection_date']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="prev_load_test_date_cert_no" id="prev_load_test_date_cert_no" value="<?php echo $pdf_form_datas[0]['prev_load_test_date_cert_no']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="next_load_test_date" id="next_load_test_date" value="<?php echo $pdf_form_datas[0]['next_load_test_date']; ?>" >
                                        </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="load_chart_in_cab" id="load_chart_in_cab" value="<?php echo $pdf_form_datas[0]['load_chart_in_cab']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="accessory_certificate" id="accessory_certificate" value="<?php echo $pdf_form_datas[0]['accessory_certificate']; ?>">
                                        </div>
                                    </div>
                                  </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="engine_serial_number" id="engine_serial_number" value="<?php echo $pdf_form_datas[0]['engine_serial_number']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="ground_clearance" id="ground_clearance" value="<?php echo $pdf_form_datas[0]['ground_clearance']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="net_power" id="net_power" value="<?php echo $pdf_form_datas[0]['net_power']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="bucket_width" id="bucket_width" value="<?php echo $pdf_form_datas[0]['bucket_width']; ?>">
                                        </div>
                                    </div>
                                  </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="bucket_capacity" id="bucket_capacity" value="<?php echo $pdf_form_datas[0]['bucket_capacity']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="dig_depth_backhoe" id="dig_depth_backhoe" value="<?php echo $pdf_form_datas[0]['dig_depth_backhoe']; ?>">
                                        </div>
                                    </div>
                                  </div>
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="inspection_date" id="inspection_date" value="<?php echo $pdf_form_datas[0]['inspection_date']; ?>">
                                        </div>
                                    </div>
                                  </div>
