                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="" name="name_of_trainee" id="name_of_trainee">
                                        </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="Number" class="" name="phone" id="phone">
                                        </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="enrolled_on" id="enrolled_on">
                                        </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                       <label class="form-label" style="color:#000 !important;">Instructor By</label>
                                        ...
                                        <?php foreach($instructor_name as $row): ?>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="valid_from" id="valid_from">
                                        </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                            <input type="date" class="" name="valid_until" id="valid_until">
                                        </div>
                                    </div>
                                  </div>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-control">
                                           <textarea id="address" name="address" class="ads"></textarea>
                                        </div>
                                    </div>
                                  </div>
...
$(document).ready(function() {
   $('#submit-btn').click(function(e) {
      ...
      $.ajax({
         url: '<?php echo base_url(); ?>pdf_admin/trainee_certificate_add_ajax',
         type: 'POST',
         dataType: 'json',
         data: formData,
